...
const _sectionScripts = {
  'products':          ['js/inventory.js','js/stockcount.js','js/catalog.js'],
  'inventory':         ['js/inventory.js','js/stockcount.js','js/catalog.js'],
  'catalog':           ['js/inventory.js','js/stockcount.js','js/catalog.js'],
