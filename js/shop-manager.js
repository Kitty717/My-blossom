...
function _smRenderOrders(){
  ...
  const cards = _smOrdersCache.map(o=>{
    ...
    if(status==='pending'){
      ...
      <button onclick="event.stopPropagation();smDeleteOrder('${o.id}')" style="padding:9px 12px;background:var(--red-soft);color:var(--red);border:none;border-radius:10px;font-size:12px;font-weight:700;cursor:pointer;font-family:inherit">🗑️</button>`;
      ...
      <button onclick="event.stopPropagation();smDeleteOrder('${o.id}')" style="padding:9px 12px;background:var(--red-soft);color:var(--red);border:none;border-radius:10px;font-size:12px;font-weight:700;cursor:pointer;font-family:inherit">🗑️ Delete</button>`;
    } else if(status==='cancelled'){
      actions = `<button onclick="event.stopPropagation();smDeleteOrder('${o.id}')" style="flex:1;padding:9px;background:var(--red-soft);color:var(--red);border:none;border-radius:10px;font-size:12px;font-weight:700;cursor:pointer;font-family:inherit">🗑️ Delete Order</button>
      ${waPhone?`<button onclick="event.stopPropagation();openCustomerWhatsApp('${o.customerPhone||''}')" style="padding:9px 12px;background:#e8f8ef;color:#2e9960;border:none;border-radius:10px;font-size:12px;font-weight:700;cursor:pointer;font-family:inherit">💬</button>`:''}`;
    }
...
function smDeleteOrder(orderId){
  appConfirm('Delete Order','Remove this order? The linked invoice will also be cancelled.','🗑️ Delete', async()=>{
    try{
